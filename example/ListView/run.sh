...
function build(){
    ...
    echo "Compiling..."
    javac -d obj -classpath src -bootclasspath $PLATFORM  src/com/beautifulzzzz/activity/*.java
...
function clean(){
    ...
    rm -rf bin/*
    rm -rf obj/*
    rm -rf src/com/beautifulzzzz/activity/R.java
}

function program(){
	echo "Launching..."
	adb install -r bin/hello.apk
	adb shell am start -n com.beautifulzzzz.activity/.MainActivity
}
...
#    export JAVA_OPTS='-XX:+IgnoreUnrecognizedVMOptions --add-modules java.se.ee'
    ...
    #https://stackoverflow.com/questions/44126015/how-to-add-google-repository-from-command-line-sdk-manager
